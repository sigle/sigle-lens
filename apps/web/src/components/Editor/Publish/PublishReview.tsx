    ...
    handleSubmit(
      ...
      (errors) => {
        setIsFormValid({
          ...
          price: errors.collect?.price?.message,
          recipients: errors.collect?.recipients
            ? "Invalid recipients"
            : undefined,
        });
      },
    ...
    <div className="space-y-4">
        ...
        <Callout.Root color="red" role="alert">
          ...
          <Text as="div" size="2">
            <ul className="list-inside list-disc">
              ...
              {isFormValid.recipients ? (
                <li>Recipients: {isFormValid.recipients}</li>
              ) : null}
            </ul>
          </Text>
        </Callout.Root>
      ...
      <Callout.Root color="orange" role="alert">
        ...
        <Callout.Text>
          ...
          {"'"}t be able to make any edits anymore.
        </Callout.Text>
      </Callout.Root>
